...
class TransitModel(object):
    ...
    def __init__(self, params, t, max_err=1.0, nthreads = 1, fac = None, transittype = "primary", supersample_factor = 1, exp_time = 0.):
        ...
        self.ds = _rsky._rsky(self.t_supersample, params.t0, params.per, params.rp, params.b, self.transittype, self.nthreads)
    ...
    def light_curve(self, params):
        ...
        if params.t0 != self.t0 or params.per != self.per or params.b != self.b or params.T14 != self.T14 or params.t_secondary != self.t_secondary:
            if self.transittype == 2 and params.t_secondary != self.t_secondary:
                params.t0 = self.get_t_conjunction(params)
            self.ds= _rsky._rsky(self.t_supersample, params.t0, params.per, params.b, params.T14, self.transittype, self.nthreads)
    ...
    def _get_phase(self, params, position):
        ...
        elif position == "primary": TA = 0.
        elif position == "secondary": TA = pi
    ...
    def get_true_anomaly(self):
        ...
        """
        self.f = _rsky._getf(self.t_supersample, self.t0, self.per, self.b, self.T14,
...
class TransitParams(object):
    ...
    :param T14: Transit duration [in same units as per].
    :type T14: float
